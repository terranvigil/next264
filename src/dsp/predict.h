 ...
 */
#ifndef NEXT264_PREDICT_H
#define NEXT264_PREDICT_H

#include <stdint.h>
#include "../common/bitdepth.h"

/* Intra16x16 prediction modes (ITU-T H.264 8.3.3). */
enum { N264_I16_VERT = 0, N264_I16_HORIZ = 1, N264_I16_DC = 2, N264_I16_PLANE = 3 };

/* Intra chroma prediction modes (8.3.4). Note the numbering differs from luma. */
enum { N264_IC_DC = 0, N264_IC_HORIZ = 1, N264_IC_VERT = 2, N264_IC_PLANE = 3 };

/* Intra4x4 prediction modes (8.3.1). */
enum {
    N264_I4_VERT = 0, N264_I4_HORIZ = 1, N264_I4_DC = 2, N264_I4_DDL = 3,
    N264_I4_DDR = 4, N264_I4_VR = 5, N264_I4_HD = 6, N264_I4_VL = 7, N264_I4_HU = 8
};
...
typedef struct { int t[16], l[8], tl; pixel f[32]; } n264_i8_edge_t;
