...
Compared to x264 on a ten-clip board with 1080p in it, multi-threaded pure C leads (0.84x), the shipped NEON build sits at 0.95x, and single-threaded pure C at 0.96x. The open item is the same on every row: low-bitrate HD, where the worst clip runs 1.16 to 1.18x against a 1.15x bar. High-bitrate 1080p is where we are fastest.
...
the shipped build (row 3) is 0.91x at CIF, 1.01x at 720p and 1.12x at 1080p,
