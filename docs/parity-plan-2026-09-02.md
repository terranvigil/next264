...
| 9 | E1 trust stored leg cost; E2 lead sweep with the settled bound; E3 pool-mutex claims; E4 CPI counters | 2 | | **E1 shipped 09-03** (`Y264_MBT_LEGTRUST` default on: t12 sunflower -1.6%, others -0.6..-0.8, shields 0; t1 -0.2..-1.0; band +0.04/+0.07 median, worst +0.63; `local/records/e1-legtrust-2026-09-03.md`). E3 re-sized at t12: pool-mutex acquire 1.0% of capacity on foreman, 1.8% sunflower (the 271 ms figure was t18); deferred behind E2. **E2 null 09-03**: leads 4..16 byte-identical and every cell inside the control's ±0.8% (`local/records/e2-lead-sweep-2026-09-03.md`); default lead stays. **E3 null 09-03**: `Y264_NTP_ROWFAST` (lock-free row claim) cuts the pool-mutex acquire 206 -> 53 ms on sunflower t12 but every wall sits inside the control at t12 and t18: the contention was off the critical path; kept default off (`local/records/e3-rowfast-2026-09-03.md`). E4 (CPI counters) not run: needs an Instruments/xctrace counters session. **Item E closed 09-03**; board after E (`docs/board-2026-09-03.md`): G1 0.96/1.19, G2 0.83/1.12, G3 0.96/1.18, all inside the day-to-day spread of 09-02b. The worst-clip remainder (shields, sunflower) has no priced arm left in E; the owner's ref-0-exit trades close goal 1 | done (E1-E3), todo (E4) |
